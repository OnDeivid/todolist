...
export default function Navbar({ user }) {
    ...
    return (
        <nav className="bg-white dark:bg-customGray fixed w-full z-20 top-0 start-0">
            <div className="max-w-screen-xl flex flex-wrap justify-between sm:justify-between md:justify-around xl:justify-between mx-auto p-4">
                ...
                <div className='flex'>
                    ...
                    <div className="flex md:order-2 m-1 space-x-3 md:space-x-0 rtl:space-x-reverse">
